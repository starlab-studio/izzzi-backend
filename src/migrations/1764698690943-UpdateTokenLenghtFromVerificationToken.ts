...
export class UpdateTokenLenghtFromVerificationToken1764698690943
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "verification_tokens" ADD "token" character varying(100) NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "verification_tokens" ADD "token" character varying(10) NOT NULL`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_b00b1be0e5a820594d7c07a3df" ON "verification_tokens" ("token") `,
    );
