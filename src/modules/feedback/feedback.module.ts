...
@Module({
  imports: [
    ...
    AiModule,
    TypeOrmModule.forFeature([FeedbackAlertModel, AlertCommentModel]),
  ],
  ...
  providers: [
    ...
    },
    {
      ...
      useFactory: (
        ...
        new GetSubjectAlertsUseCase(
          logger,
          aiClientService,
          feedbackAlertRepository
        ),
      inject: [LoggerService, AiClientService, "FEEDBACK_ALERT_REPOSITORY"],
    },
    {
