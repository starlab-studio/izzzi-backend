...
export class SeedFaqData1769000000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Get Tab ID
    const tabs = await queryRunner.query(`SELECT id FROM "faq_tabs" WHERE "label_tab" = 'Aide' LIMIT 1`);
        ...
        items: [
          {
            ...
            answer: "Izzzi permet de collecter les retours des étudiants en temps réel pour améliorer l'enseignement."
          },
          {
          ...
          },
          {
            ...
            answer: {
              paragraph: "Tous les retours sont centralisés dans un dashboard clair et interactif. Vous pouvez :",
              list: [
        ...
        items: [
          {
            ...
            answer: "Pour créer un nouveau cours, rendez-vous dans votre dashboard et cliquez sur 'Nouveau cours'. Vous pourrez ensuite configurer les paramètres et inviter vos étudiants."
          },
          {
            question: "Comment partager un questionnaire avec mes étudiants ?",
            answer: "Une fois votre cours créé, vous pouvez générer un QR code ou un lien de partage directement depuis votre dashboard. Les étudiants peuvent scanner le QR code ou cliquer sur le lien pour accéder au questionnaire."
          },
          {
            question: "Puis-je utiliser izzzi pendant le cours ?",
            answer: "Oui, izzzi est conçu pour être utilisé en temps réel pendant vos cours. Les étudiants peuvent donner leurs retours instantanément, et vous pouvez voir les résultats en direct."
          }
        ]
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            answer: "Les alertes se déclenchent automatiquement quand izzzi détecte des signaux faibles dans les retours (positifs ou négatifs). Vous recevez une notification par email pour vous permettre d'agir rapidement."
          },
          {
            question: "Puis-je personnaliser les questionnaires ?",
            answer: "Actuellement, les questionnaires sont standardisés pour garantir une cohérence dans l'analyse. La personnalisation des questionnaires est prévue dans une prochaine mise à jour."
          }
        ]
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            answer: "Vos données sont stockées de manière sécurisée sur des serveurs européens conformes au RGPD. Nous ne partageons jamais vos données avec des tiers sans votre consentement explicite."
          },
          {
            question: "Puis-je supprimer mes données ?",
            answer: "Oui, vous pouvez demander la suppression de vos données à tout moment en contactant notre équipe. Nous nous engageons à traiter votre demande dans les plus brefs délais."
          }
        ]
      },
      {
        ...
        items: [
          {
            ...
            answer: "En tant qu'administrateur, vous pouvez inviter des membres de votre équipe et définir leurs permissions. Chaque membre peut avoir des droits différents selon son rôle."
          },
          {
            question: "Comment facturer l'utilisation de izzzi ?",
            answer: "La facturation se fait selon le nombre d'utilisateurs actifs et de questionnaires envoyés. Vous pouvez consulter votre consommation en temps réel dans votre espace administrateur."
          },
          {
            question: "Puis-je intégrer izzzi avec mon LMS existant ?",
            answer: "Oui, izzzi propose des intégrations avec les principaux LMS (Moodle, Canvas, etc.). Contactez notre équipe pour configurer l'intégration selon vos besoins."
          }
        ]
      }
    ];
    ...
    for (const cat of categories) {
      ...
      // Get Category ID
      const savedCats = await queryRunner.query(`SELECT id FROM "faq_categories" WHERE "label_category" = $1 AND "faq_tab_id" = $2`, [cat.label, tabId]);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DELETE FROM "faq_tabs" WHERE "label_tab" = 'Aide'`);
  }
}